...
class Response {
    ...
    public function build(ResponseEnum $buildAs = ResponseEnum::JSON)
    {
        return [
            'header' => $buildAs->value,
            'httpCode' => $this->_code,
    ...
    public function unauthorized(string $message = '', array $data = [])
    {
        $this->data($data);
        $this->message($message);
        $this->code(self::HTTP_UNAUTHORIZED);
        return $this;
    }

    public function badRequest(string $message = '', array $data = [])
    {
        $this->data($data);
        $this->message($message);
    ...
    public function forbidden(string $message = '', array $data = [])
    {
        $this->data($data);
        $this->message($message);
    ...
    public function notFound(string $message, array $data)
    {
        $this->data($data);
        $this->message($message);
